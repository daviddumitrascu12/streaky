...
function sanitize(input) {
  ...
  s.lastEventText = String(s.lastEventText || 'Bereit');
...
${state.lastSyncText || ''}`;
  $('serverLabel').textContent = DEFAULT_SERVER_URL;
}
...
$('syncNow').addEventListener('click', () => {
  state.lastEventText = state.username ? `Sync gestartet für ${state.username}` : 'Bitte zuerst einen Namen setzen';
  save(false);
